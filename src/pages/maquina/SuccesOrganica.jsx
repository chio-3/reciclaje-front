// File: components/OrganicMaterialSuccess.jsx
import React from "react";
import { FaCheckCircle, FaBalanceScale, FaUserCheck } from "react-icons/fa";
import { useNavigate } from "react-router-dom";

export default function SuccesOrganica() {
      ...
      <div className="bg-green-800 text-white w-[400px]  mx-auto rounded-xl p-6 flex flex-col justify-between">
        <div>
          ...
          <div className="flex items-center mb-2">
            <FaBalanceScale className="mr-2" /> Peso detectado: <span className="ml-1 font-bold">20,0 kg</span>
          </div>
          <div className="flex items-center">
            <FaUserCheck className="mr-2" /> Usted tiene <span className="ml-1 font-bold">+300 puntos</span>
          </div>
        </div>
