...
export default function EditarReciclaje() {
  ...
  return (
    <div className="text-white rounded-xl w-full max-w-md bg-zinc-900 p-6">
      ...
      <div className="flex items-start gap-2 mb-6">
        ...
        <p className="text-sm">Inorganico reciclables</p>
      </div>
      ...
      <div className="space-y-4 mb-6">
        ...
        <button
          className="bg-blue-600 hover:bg-blue-700 text-white py-1.5 px-4 rounded-md flex items-center gap-2"
        >
          <FaPlus className="text-lg" /> Añadir
        </button>
      </div>
